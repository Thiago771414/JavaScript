...
console.log(`resto da divisão 19 % 3 = ${19 % 5}`);
console.log(`exponenciação 3 ** 4 = ${3 ** 4}`);
...
console.log(`x === y: ${x === y}`);
console.log(`a === b: ${a === b}`);
console.log(`typeof x: ${typeof x}`);//typeof é o tipo da variável
console.log(`typeof a: ${typeof a}`);//typeof é o tipo da variável indexof é a busca
